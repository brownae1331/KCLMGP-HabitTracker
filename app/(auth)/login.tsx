...
import { clearUsersTable } from '@/lib/database';
    ...
    const handleClearDatabase = async () => {
        try {
            ...
            if (err instanceof Error) {
                ...
                setError('An unknown error occurred while clearing the database.');
            }
        }
    };
        ...
        <SafeAreaView style={styles.background}>
            <ScrollView contentContainerStyle={styles.container} keyboardDismissMode="on-drag">
                <TouchableOpacity style={styles.clearButton} onPress={handleClearDatabase}>
                    <ThemedText style={styles.clearButtonText}>Clear DB</ThemedText>
                </TouchableOpacity>

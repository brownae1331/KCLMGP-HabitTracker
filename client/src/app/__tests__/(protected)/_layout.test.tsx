...
describe('AccountScreen', () => {
    ...
    test('loads and displays user data from AsyncStorage when email exists', async () => {
        ...
        // Wait for user data to load and check that the username and email fields display the correct values
        await waitFor(() => {
    ...
    test('logs error if loadUserData fails in useEffect', async () => {
        ...
        // Wait for useEffect to complete and expect console.error to be called with the error message
        await waitFor(() => {
    ...
    test('displays error message on password update failure', async () => {
        ...
        (useTheme as jest.Mock).mockReturnValue({ theme: 'light' });
        // Simulate updatePassword failure with an Error instance
